...
async function askGemini(jid, prompt, isOwnerMessage = false) {
    ...
    try {
        ...
        let systemInstruction = isOwnerMessage
            ? "أنت الذكاء الاصطناعي الخاص والمساعد المباشر للمبرمج عامر الخضمي. أنت الآن تتحدث مع عامر نفسه (المالك). أجب عليه مباشرة، نفذ أوامره بدقة، كن عملياً ومختصراً.\n\n"
            : "تعليمات مساعدة لعامر:\n1. لا تخبر أحداً أنك مساعد أو ذكاء اصطناعي إلا إذا سألك مباشرة.\n2. قلد نفس أسلوب المتحدث.\n3. أجب بشكل طبيعي كأنك تدردش عبر الواتساب.\n\n";
